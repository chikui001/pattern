...
public class MaterialProgressDrawable extends Drawable implements Animatable {
	...
	public void setSizeParameters(double progressCircleWidth, double progressCircleHeight, double centerRadius, double strokeWidth,
	...
	public void updateSizes(@ProgressDrawableSize int size) {
		...
		if (size == LARGE) {
			...
			setSizeParameters(CIRCLE_DIAMETER * screenDensity, CIRCLE_DIAMETER * screenDensity, CENTER_RADIUS * screenDensity,
							  STROKE_WIDTH * screenDensity, ARROW_WIDTH * screenDensity, ARROW_HEIGHT * screenDensity);
		}
	}
	...
	private void applyFinishTranslation(float interpolatedTime, Ring ring) {
		...
		final float startTrim =
				ring.getStartingStartTrim() + (ring.getStartingEndTrim() - ring.getStartingStartTrim()) * interpolatedTime;
